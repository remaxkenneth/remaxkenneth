...
const LANG = {
  ...
  es: {
    ...
    'index.about.title':   'Tu Experto en Bienes Ra\u00edces de Baja',
    'index.about.pretitle':'Acerca de Kenneth',
    'index.about.body1':   'Con a\u00f1os de experiencia en el corredor de Todos Santos y Cerritos, Kenneth ayuda a sus clientes a navegar el mercado inmobiliario de Baja con claridad, confianza y experiencia local de confianza. Desde villas privadas hasta propiedades de inversi\u00f3n y casas frente al mar, Kenneth cuida cada transacci\u00f3n con esmero y profundo conocimiento de la regi\u00f3n.',
    ...
    'index.events.music.name':     'Noches en Baja',
    ...
    'listing.casa_sol.desc': '<p>Donde el desierto se encuentra con el mar, y el sol con la luna. Casa Sol y Luna es una propiedad \u00fanica en Baja ubicada en un terreno de 1,800 m\u00b2 sobre Playa Los Cerritos, entre dos ic\u00f3nicas rompientes donde los atardeceres pintan el cielo durante todo el a\u00f1o.</p><p>Con tres casitas independientes rodeadas de jardines nativos, la propiedad incluye una piscina y m\u00faltiples \u00e1reas de vida al aire libre dise\u00f1adas para aprovechar al m\u00e1ximo el clima y el entorno natural de Baja.</p><p>Ubicada a minutos de Cerritos Beach y cerca de Todos Santos y El Pescadero, Casa Sol y Luna ofrece privacidad, elevaci\u00f3n y un relajado estilo de vida costero.</p>',
